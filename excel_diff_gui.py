...
def load_labels():
    """
    Merge JSON label files from most preferred to least.
    Locale file pattern is locales/<locale_tag>_gui.json (e.g., en_GB_gui.json, en_gui.json).
    Variant (e.g., en_GB_gui.json) overrides base (en_gui.json).
    """
    merged = {}
    tried = set()
